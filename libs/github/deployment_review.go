...
// PendingDeploymentInfo contains information about a pending deployment.
type PendingDeploymentInfo struct {
	// Environment is the name of the GitHub environment that is being requested for deployment.
	Environment string
}
